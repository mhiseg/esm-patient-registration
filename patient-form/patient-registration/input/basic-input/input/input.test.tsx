...
//         <Form>
//           <Input id="number" labelText="Number" name="number" size={''} />
//         </Form>
//       </Formik>,
//     );
...
//         <Form>
//           <Input id="text" labelText="Text" name="text" placeholder="Enter text" size={''} />
//         </Form>
//       </Formik>,
//     );
...
//             placeholder="Enter telephone number" size={''}            
//           />
//         </Form>
//       </Formik>,
//     );
...
//         <Form>
//           <Input id="date" labelText="date" name="date" size={''} />
//         </Form>
//       </Formik>,
//     );
...
//   it('exists', async () => {
//     const input = await setupInput();npm i react-input-mask
//   });
...
//         <Form>
//           <Input id="checkbox" labelText="checkbox" name="checkbox" size={''}  />
//         </Form>
//       </Formik>,
//     );
